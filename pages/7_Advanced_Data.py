...
with st.expander("Class imbalance"):
    ...
    st.write("When looking at the imbalance, we notice the heart disease dataset is no differet."
             "The number of people with Heart disease or Heart attack is " + str(sum(int(df_heart['HeartDiseaseorAttack']))) + ". Compare that to the total number of people: " + str(len(df_heart['HeartDiseaseorAttack'])) + ".")
